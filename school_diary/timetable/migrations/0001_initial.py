# Generated by Django 3.1.2 on 2021-03-01 19:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.IntegerField(choices=[(1, 'Младшая школа'), (2, 'Средняя и старшая школа')],
                                               verbose_name='Школа')),
            ...
            fields=[
                ...
                ('day', models.CharField(
                    choices=[('Понедельник', 'Понедельник'), ('Вторник', 'Вторник'), ('Среда', 'Среда'),
                             ('Четверг', 'Четверг'), ('Пятница', 'Пятница'), ('Суббота', 'Суббота')], max_length=11,
                ...
                ('connection', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                 related_name='t_grade', to='timetable.grades', verbose_name='Класс')),
                ('number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timetable.bellstimetable',
