...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', core.users.manager.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='AdminMessages',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('h_file', models.FileField(blank=True, default=None, null=True, upload_to=core.models.homework_upload, verbose_name='Файл')),
