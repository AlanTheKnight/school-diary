...
def dashboard(request, page):
    ...
    return render(request, 'minimum/minimum/dashboard.html', {'minimums': minimums})
...
def update(request, id):
    ...
    return render(request, 'minimum/minimum/update.html', {'form': form, })
...
def delete(request, id):
    ...
    if request.method == "POST":
        m.delete()
        return redirect('/minimum/dashboard/1')
    return render(request, 'minimum/minimum/delete.html', {'m': m})
...
def create(request):
    ...
    return render(request, 'minimum/minimum/create.html', {'form': form})
